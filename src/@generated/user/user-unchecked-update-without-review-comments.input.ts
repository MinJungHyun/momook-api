...
import { ReviewCommentMoodUncheckedUpdateManyWithoutUserNestedInput } from '../review-comment-mood/review-comment-mood-unchecked-update-many-without-user-nested.input';
...
@InputType()
export class UserUncheckedUpdateWithoutReviewCommentsInput {
    ...
    @Field(() => ReviewCommentMoodUncheckedUpdateManyWithoutUserNestedInput, {nullable:true})
    reviewCommentMoods?: ReviewCommentMoodUncheckedUpdateManyWithoutUserNestedInput;
