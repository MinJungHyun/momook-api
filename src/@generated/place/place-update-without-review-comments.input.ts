...
import { ReviewCommentMoodUpdateManyWithoutPlaceNestedInput } from '../review-comment-mood/review-comment-mood-update-many-without-place-nested.input';
...
@InputType()
export class PlaceUpdateWithoutReviewCommentsInput {
    ...
    @Field(() => ReviewCommentMoodUpdateManyWithoutPlaceNestedInput, {nullable:true})
    reviewCommentMoods?: ReviewCommentMoodUpdateManyWithoutPlaceNestedInput;
