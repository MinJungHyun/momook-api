...
import { ReviewCommentUncheckedUpdateManyWithoutPlaceNestedInput } from '../review-comment/review-comment-unchecked-update-many-without-place-nested.input';
...
@InputType()
export class PlaceUncheckedUpdateWithoutReviewCommentMoodsInput {
    ...
    @Field(() => ReviewCommentUncheckedUpdateManyWithoutPlaceNestedInput, {nullable:true})
    reviewComments?: ReviewCommentUncheckedUpdateManyWithoutPlaceNestedInput;
